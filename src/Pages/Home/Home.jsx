...
<div className='Home mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 md:h-[550px]' id='/' data-aos="fade-in">
    <div className="user p-20 flex flex-col justify-center items-start rounded-3xl text-2xl">
        ...
        <button className='download-cv mt-5 bg-orange-600 p-2 rounded-2xl'>
          <a className='text-[18px] hover:animate-pulse' href="https://docs.google.com/document/d/1601EGIGfAK6cIqLJF-a3SDg50LXwa6zj/edit?usp=drive_link&ouid=105421835892136621650&rtpof=true&sd=true" target="_blank" rel='noreferrer'>
            Download CV
          </a>
        </button>
