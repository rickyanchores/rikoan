...
const Home = () => {
  return (
<div className='Home h-screen p-5 flex flex-wrap  md:flex-col gap-4'>
    ...
    <div className="right p-6 w-full md:h-full  md:w-2/4 rounded-2xl flex flex-col justify-center items-center">
