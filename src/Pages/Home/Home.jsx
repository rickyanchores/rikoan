...
<div className='Home mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 md:h-[550px]' id='/'>
    <div className="user p-20 flex flex-col justify-center items-start rounded-lg text-2xl">
    ...
    <div className="right p-20 flex flex-col justify-center items-center rounded-lg">
